...
class CertificateDetailView: UIView {
    ...
    private func addTestEntries() {
        ...
        for test in tests {
            ...
            let texts = test.isNegative ? UBLocalized.translationWithEnglish(key: .wallet_certificate_test_result_negativ_key) : !test.isSerologicalTest ? UBLocalized.translationWithEnglish(key: .wallet_certificate_test_result_positiv_key) : UBLocalized.translationWithEnglish(key: .covid_certificate_sero_positiv_test_befund_value_key)
